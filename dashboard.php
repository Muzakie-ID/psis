...
<body>
    <div class="sidebar" id="sidebar">
        <div class="logo">
            <i class="fas fa-shield-alt"></i><span class="logo-text">Sistem Pengaduan</span>
        </div>
        <ul class="sidebar-menu">
            <li class="menu-item active" data-page="dashboard"><i class="fas fa-home"></i><span class="menu-text">Dashboard</span></li>
            <li class="menu-item" data-page="complaint"><i class="fas fa-plus-circle"></i><span class="menu-text">Buat Pengaduan</span></li>
            <li class="menu-item"><a href="history.php" style="display:flex; align-items:center; gap:12px; text-decoration:none; color:inherit; width:100%;"><i class="fas fa-history"></i><span class="menu-text">Riwayat</span></a></li>
            <li class="menu-item" data-page="profile"><i class="fas fa-user"></i><span class="menu-text">Profil</span></a></li>
            <li class="menu-item" id="logout-btn"><i class="fas fa-sign-out-alt"></i><span class="menu-text">Keluar</span></li>
        </ul>
    </div>
        ...
        <div class="content">
            ...
            <div class="page active" id="dashboard-page">
                <div class="dashboard-grid">
                    <div class="card card-warning"><i class="fas fa-exclamation-circle"></i><div class="card-title">Pengaduan Baru</div><div class="card-value"><?= $counts['pending'] ?></div></div>
                    <div class="card card-primary"><i class="fas fa-tasks"></i><div class="card-title">Sedang Diproses</div><div class="card-value"><?= $counts['process'] ?></div></div>
                    <div class="card card-success"><i class="fas fa-check-circle"></i><div class="card-title">Selesai</div><div class="card-value"><?= $counts['resolved'] ?></div></div>
                </div>
    ...
    <div class="logout-modal" id="logout-modal" style="display:none; position:fixed; ...">
    ...
    <script>
        // ... (kode script JS untuk fetch pengaduan terbaru) ...
    </script>
